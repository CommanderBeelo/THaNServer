...
{
	bool ShowLogo = true;
	string LogoPath = "THaNServer/GUI/namalskbiglogo.edds";
	bool RandomizeBackgounds = true;
	int LoadingBarColor = ARGB(255, 199, 38, 81);
	bool UseCustomHints = true;
	string HintIconPath = "THaNServer/GUI/icons/circle_info.edds";
	...
	void CustomLoadingScreenData()
	{
		...
		JsonFileLoader<array<ref CustomLoadingScreenBackground>>.JsonLoadFile("THaNServer/Scripts/Data/LoadingImages.json", m_ExBackgrounds);
	}
};

modded class UiHintPanel
{
	protected const string 	m_ExDataPath = "THaNServer/Scripts/Data/Hints.json"; //! Custom hints json path
...
modded class LoadingScreen
{
	...
	void LoadingScreen(DayZGame game)
	{
		...
		m_ExHintIcon = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("THaNServer/GUI/layouts/hint_icon.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.ShowLogo && m_ExCustomLoadingScreenData.LogoPath != string.Empty)
		{
			...
			m_ImageLogoCorner = ImageWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("THaNServer/GUI/layouts/logo.layout", m_ExPanelWidget));
		...
		if (m_ExCustomLoadingScreenData.LoadingBarColor != 0)
		{
			...
			m_ProgressLoading = ProgressBarWidget.Cast(game.GetLoadingWorkspace().CreateWidgets("THaNServer/GUI/layouts/loading_bar.layout", m_ExPanelWidget));
